# Script para reemplazar todas las referencias de 'cart' por 'carrito' en cart-system-simple.js
$filePath = "c:\xampp\htdocs\Musa\js\cart-system-simple.js"
...
Write-Host "✅ Reemplazos completados en cart-system-simple.js"
